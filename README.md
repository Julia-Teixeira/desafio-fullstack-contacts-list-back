...
- Digite o comando npm, pnpm ou yarn run start ou pnpm ou yarn run start:dev, isso colocará a API em funcionamento no seguinte endereço: http://localhost:3333;
